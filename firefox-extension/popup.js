// Popup script for the Firefox bookmark extension
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  // Get current tab info - use browser API for Firefox compatibility
...
async function openAppWithBookmarkData() {
  ...
  await browser.tabs.create({ url: `${APP_URL}/bookmark/new?${params.toString()}` });
  window.close();
}
