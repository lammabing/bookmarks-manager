import BookmarkHTMLParser from './src/utils/BookmarkHTMLParser.js';

// Test the parser with the sample file
const parsedItems = BookmarkHTMLParser.parseHTMLContent(`
...
parsedItems.forEach((item, index) => {
  console.log(`${index + 1}. Type: ${item.type}, Name/Title: ${item.title || item.name}, URL: ${item.url || 'N/A'}, Parent: ${item.parentId || 'None'}`);
});